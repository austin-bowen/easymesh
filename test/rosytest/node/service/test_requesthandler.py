...
class TestServiceRequestHandler:
    def setup_method(self):
        self.service_handler_manager = create_autospec(ServiceHandlerManager)
    ...
    async def test_handle_request_sends_result_on_success(self):
        ...
        self.service_handler_manager.get_handler.return_value = handler
        ...
        self.service_handler_manager.get_handler.assert_called_once_with('service')
    ...
    async def test_handle_request_sends_error_if_service_not_provided(self):
        self.service_handler_manager.get_handler.return_value = None
        ...
        self.service_handler_manager.get_handler.assert_called_once_with('unknown_service')
        self.node_message_codec.encode_service_response.assert_awaited_once_with(
            self.writer,
            expected_response,
        )
